...
-- NOTE: This migration is temporarily skipped because agent_templates table is created later

BEGIN;

-- This migration will be run after agent_templates table is created
-- Temporarily commenting out to allow other migrations to proceed
