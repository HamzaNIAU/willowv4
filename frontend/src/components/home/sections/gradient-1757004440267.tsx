...
// Generated at: 2025-09-04T16:53:45.355Z
// Settings: gradient-1757004440267
...
const Gradient1757004440267ShaderMaterial = shaderMaterial(
  {
    uTime: 0,
    uAspect: 1,
    uLightColour: new Color('#ff00ff'),
    uMidColour: new Color('#ff0000'),
    uOffBlackColour: new Color('#ffffff'),
    uBlackColour: new Color('#3235f2'),
...
extend({ Gradient1757004440267ShaderMaterial })

// TypeScript declaration for the custom shader material
declare global {
  namespace JSX {
    interface IntrinsicElements {
      gradient1757004440267ShaderMaterial: any
    }
  }
}
...
function GradientPlane() {
  ...
  return (
    <Plane args={[viewport.width * 3, viewport.height * 3, 1, 1]} position={[0, 0, -6]}>
      <gradient1757004440267ShaderMaterial
        ref={shader}
