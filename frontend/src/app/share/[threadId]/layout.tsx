...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | Rzvi Willow',
    description: 'Replay this Agent conversation on Rzvi Willow',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | Rzvi Willow';
    const description =
      projectData.description ||
      'Replay this Agent conversation on Rzvi Willow';
