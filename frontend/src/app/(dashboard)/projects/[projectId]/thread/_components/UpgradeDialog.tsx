...
export function UpgradeDialog({ open, onOpenChange, onDismiss }: UpgradeDialogProps) {
  ...
  return (
    <UnifiedUpgradeDialog
      ...
      icon={Crown}
      title="Unlock the Full Willow Experience"
      description="You're currently using Willow's free tier with limited capabilities. Upgrade now to access our most powerful AI model."
      theme="primary"
      size="sm"
